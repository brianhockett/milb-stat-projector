...
data_dir = os.path.join(home_dir, 'milb_data')

# Scraping Batter Data
for year in years:
    print(f"Scraping MiLB Batter Data for {year}\n")
    ...
    if data:
        ...
        print(f'No MiLB Batter Data for {year}\n')    

    time.sleep(1)

# Scraping Pitcher Data
for year in years:
    print(f"Scraping MiLB Pitcher Data for {year}\n")
    ...
    if data:
        ...
        print(f'No MiLB Pitcher Data for {year}\n')    
